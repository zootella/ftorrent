...
CString PathStore();
CString PathOption();
CString PathTorrentMeta(libtorrent::big_number hash);
CString PathTorrentStore(libtorrent::big_number hash);
CString PathTorrentOption(libtorrent::big_number hash);

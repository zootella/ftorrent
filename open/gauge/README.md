...
At idle with near-zero traffic, the three containers use roughly 5 MiB (UDP), 27 MiB (HTTP), and 34 MiB (WebSocket). The HTTP and WS numbers are higher because of the fixed io_uring buffers, not because they're doing more work.
